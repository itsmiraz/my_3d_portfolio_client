      ...
      <motion.div variants={textVariant()}>
        ...
        <div className="relative text-gray-500 my-2 py-2 ">
          <div className="absolute">
            ...
            <div className="h-20 w-[1px] left-1 top-0 bg-gray-600"></div>
            <p className="text-xs"><span>{'<'}</span> h1  <span>{'/>'}</span></p>
          </div>

          <div className="pl-3">
          <h2 className="bg-clip-text text-8xl font-bold  text-transparent bg-gradient-to-r from-pink-500 to-violet-500">Overview.</h2>
         </div>
        </div>
      </motion.div>

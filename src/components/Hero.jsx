...
const Hero = () => {
  return (
    <div
      id="#"
      className="py-10 overflow-hidden relative  place-items-center grid grid-cols-1  md:grid-cols-2"
    >
      <motion.div
      ...
      <div className="backdrop-blur-lg   box-shadow  bg-gradient-to-r md:bg-gradient-to-t from-fuchsia-800 to-blue-800 md:w-10 w-72 h-12 md:h-72 absolute left-0 -md:left-20 bottom-0 md:top-40 rounded-r-lg">
        <div className="flex flex-row md:flex-col gap-x-5 items-center gap-y-0 md:gap-y-5 justify-center">
          <a
            target={"_blank"}
            rel="noreferrer"
            href="https://www.linkedin.com/in/mirajhossen/"
            title="Twitter"
          ...
          <a
            target={"_blank"}
            rel="noreferrer"
            href="https://github.com/itsmiraz"
            title="Github"
          ...
          <a
            target={"_blank"}
            rel="noreferrer"
            href="https://www.facebook.com/Iammirajhossen"
            title="Facebook"
            className="flex items-center justify-center  rounded-full sm:w-10 sm:h-10  text-gray-100"
          >
            <svg
          ...
          <a
            target={"_blank"}
            rel="noreferrer"
            href="https://www.instagram.com/its_miraz_/"
            title="Instagram"
            className="flex items-center justify-center  rounded-full sm:w-10 sm:h-10  text-gray-100"
          >
            <svg
          ...
          <a
            target={"_blank"}
            rel="noreferrer"
            href="https://twitter.com/iammirajhossen"
            title="Twitter"
            className="flex items-center justify-center rounded-full sm:w-10 sm:h-10  text-gray-100"
          >
            <svg
